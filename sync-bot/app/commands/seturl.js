...
module.exports = {
	...
	data: new SlashCommandBuilder()
		.setName("seturl")
		.setDescription("Set the URL of the Ember instance to link this Discord guild with.")
		.addStringOption((option) =>
			option.setName("url").setDescription("http(s)://example.com").setRequired(true)
		),
	guildOnly: true,
	async execute(interaction) {
		...
		interaction.client.database.Guild.findOne({
			...
			if (guild === null) return interaction.editReply("Assign the sync token first.");
